...
def test_dlp_and_outbound_normalization_and_exclusion(tmp_path: Path):
    dlp = tmp_path / "cache/dlp/2026-07-22.jsonl"; dlp.parent.mkdir(parents=True); dlp.write_text(json.dumps({"event_id": "Content Threat Blocked", "eventtimelocal": "2026-07-22 10:00:00", "machine_name": "PC", "filename": "secret.txt", "destination": "USB"}) + "\n", encoding="utf-8")
